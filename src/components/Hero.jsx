...
const Hero = () => {
    return (
        <section className="text-center bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 py-24 px-6 transition-colors duration-300">
            {/* TITLE */}
            ...
            {/* SUBTEXT */}
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-12 text-lg leading-relaxed font-normal">
            ...
            <div className="flex justify-center items-center space-x-4">
                ...
                <Link
                    to="/create"
                    className="flex items-center px-7 py-3 bg-green-600 text-white font-semibold text-base rounded-full shadow hover:bg-green-700 hover:scale-105 transition duration-300"
                >
                ...
                <Link
                    to="/projects"
                    className="flex items-center px-7 py-3 border-2 border-green-600 text-green-700 dark:text-green-300 font-semibold text-base rounded-full bg-transparent dark:bg-gray-700 hover:bg-green-100 dark:hover:bg-gray-600 transition duration-300"
                >
            ...
            <div className="flex justify-center items-stretch mt-16 space-x-4 max-w-3xl mx-auto">
                ...
                {/* Donated */}
                <div className="flex flex-col flex-1 justify-center items-center p-5 bg-white dark:bg-gray-700 shadow-md rounded-2xl border-t-4 border-blue-500 transition-colors duration-300">
